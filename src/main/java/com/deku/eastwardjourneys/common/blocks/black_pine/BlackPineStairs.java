...
public class BlackPineStairs extends AbstractWoodenStairsBlock {
    public BlackPineStairs() {
        super(ModBlockInitializer.BLACK_PINE_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.of().strength(2.0f, 3.0f).mapColor(MapColor.WOOD).ignitedByLava().sound(SoundType.WOOD).instrument(NoteBlockInstrument.BASS));
    }
}
