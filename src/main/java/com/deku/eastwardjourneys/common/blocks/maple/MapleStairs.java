...
public class MapleStairs extends AbstractWoodenStairsBlock {
    public MapleStairs() {
        super(ModBlockInitializer.MAPLE_PLANKS.get().defaultBlockState(), Properties.of().strength(2.0f, 3.0f).mapColor(MapColor.WOOD).ignitedByLava().sound(SoundType.WOOD).instrument(NoteBlockInstrument.BASS));
    }
}
