...
public class SaxaulStairs extends AbstractWoodenStairsBlock {
    public SaxaulStairs() {
        super(ModBlockInitializer.SAXAUL_PLANKS.get().defaultBlockState(), Properties.of().strength(2.0f, 3.0f).mapColor(MapColor.COLOR_LIGHT_GRAY).ignitedByLava().sound(SoundType.WOOD).instrument(NoteBlockInstrument.BASS));
    }
}
