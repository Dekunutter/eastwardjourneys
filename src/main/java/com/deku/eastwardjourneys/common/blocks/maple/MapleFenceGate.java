...
public class MapleFenceGate extends FenceGateBlock {
    public MapleFenceGate() {
        super(ModWoodType.MAPLE, Properties.of().strength(2.0f, 3.0f).mapColor(MapColor.WOOD).sound(SoundType.WOOD).ignitedByLava().instrument(NoteBlockInstrument.BASS));
    }
}
