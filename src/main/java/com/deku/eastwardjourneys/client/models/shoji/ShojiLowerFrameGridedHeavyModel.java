...
public class ShojiLowerFrameGridedHeavyModel extends AbstractShojiFrameModel {
    private final ModelPart frame;

    public ShojiLowerFrameGridedHeavyModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition frame = partdefinition.addOrReplaceChild("frame", CubeListBuilder.create().texOffs(26, 0).addBox(-16.0F, -9.0F, 13.0F, 16.0F, 9.0F, 3.0F, new CubeDeformation(0.0F))
            .texOffs(10, 25).addBox(-2.0F, -16.0F, 13.0F, 2.0F, 7.0F, 3.0F, new CubeDeformation(0.0F))
            .texOffs(0, 25).addBox(-16.0F, -16.0F, 13.0F, 2.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(8.0F, 24.0F, -8.0F));
        ...
        PartDefinition grid = frame.addOrReplaceChild("grid", CubeListBuilder.create().texOffs(0, 12).addBox(-14.0F, -16.0F, 13.0F, 12.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
            ...
            .texOffs(56, 27).addBox(-11.0F, -15.0F, 13.0F, 1.0F, 6.0F, 3.0F, new CubeDeformation(0.0F))
            .texOffs(56, 27).addBox(-6.0F, -15.0F, 13.0F, 1.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
