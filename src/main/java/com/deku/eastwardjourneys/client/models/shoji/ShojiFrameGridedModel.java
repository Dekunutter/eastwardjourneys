...
public class ShojiFrameGridedModel extends AbstractShojiFrameModel {
    private final ModelPart frame;

    public ShojiFrameGridedModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition grid = frame.addOrReplaceChild("grid", CubeListBuilder.create().texOffs(0, 12).addBox(-14.0F, -26.0F, 13.0F, 12.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
            ...
            .texOffs(56, 27).addBox(-11.0F, -30.0F, 13.0F, 1.0F, 28.0F, 3.0F, new CubeDeformation(0.0F))
            .texOffs(56, 27).addBox(-6.0F, -30.0F, 13.0F, 1.0F, 28.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
